          ...
          <div className="relative w-full max-w-md space-y-8">
            ...
            <form className="space-y-5">
              ...
              <div className="flex gap-4">
                <Button formAction={login} className="h-12 w-full rounded-full">Log in</Button>
                <Button formAction={signup} variant="outline" className="h-12 w-full rounded-full">Sign up</Button>
              </div>
            </form>
